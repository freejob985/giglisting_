...
<head>
    ...
    @if($site_global_settings->setting_site_favicon)
        <link rel="icon" type="icon" href="src="http://gigworldgo.com/assets/uploads/media-uploader/logo1588283745.gif"" sizes="96x96"/>
    @else
...
.text-left {
    ...
    position: absolute;
    left: 10px;
    right: auto;}.owl-carousel{direction:ltr;}
</style>
@endif
