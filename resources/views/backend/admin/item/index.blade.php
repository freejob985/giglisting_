...
@section('styles')
    <link href="{{ asset('frontend/vendor/rateyo/jquery.rateyo.min.css') }}" rel="stylesheet" />
@endsection
                            ...
                            <form method="GET" action="{{ route('admin.items.index') }}">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <select class="custom-select @error('filter_country') is-invalid @enderror" name="filter_country" id="filter_country">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <select class="custom-select @error('filter_state') is-invalid @enderror" name="filter_state" id="filter_state">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <select class="custom-select @error('filter_city') is-invalid @enderror" name="filter_city" id="filter_city">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <select class="custom-select @error('filter_count_per_page') is-invalid @enderror" name="filter_count_per_page" id="filter_count_per_page">
