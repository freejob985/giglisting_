...
<head>
    ...
    @endif
       <style>.custom-select[multiple], .custom-select[size]:not([size="1"]) {
    width: 100%;
    height: 240px!important;
    padding-right: .75rem;
    background-image: none;
}option:nth-child(1),option:nth-child(9),option:nth-child(20){color:purple;background:gold;padding:4px;}</style>
