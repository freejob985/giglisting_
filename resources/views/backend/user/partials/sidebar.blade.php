...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('user.index') }}">
        ...
        <div class="sidebar-brand-text mx-3"><img class="full" alt="" data-src="https://gigworldgo.com/assets/uploads/media-uploader/logo1588283745.gif" style="width:120px;" src="https://gigworldgo.com/assets/uploads/media-uploader/logo1588283745.gif"></div>
    </a>
